  ...
  <div id="learning-items-holder">
    <div className="this-inner">
      ...
      <div className="learning-item">
        ...
        <div className="this-blurb">
          <div className="this-inner">
            <a href="">5 under-the-radar Caribbean escapes</a>
          </div>
        </div>
      </div>
      <div className="learning-item">
        ...
        <div className="this-blurb">
          <div className="this-inner">
            <a href="">How one entrepreneur made a space for home, and work</a>
          </div>
        </div>
      </div>
      <div className="learning-item">
        ...
        <div className="this-blurb">
          <div className="this-inner">
            <a href="">Beat the crowds at these under-the-radar ski resorts</a>
          </div>
        </div>
      </div>
      <div className="learning-item">
        ...
        <div className="this-blurb">
          <div className="this-inner">
            <a href="">Why national parks are great winter vacations</a>
          </div>
        </div>
      </div>
      <div className="learning-item">
        ...
        <div className="this-blurb">
          <div className="this-inner">
            <a href="">Five ways to save money on winter sports</a>
          </div>
        </div>
      </div>
      <div className="learning-item">
        ...
        <div className="this-blurb">
          <div className="this-inner">
            <a href="">9 Budget-friendly tips to freshen up your home in the new year</a>
          </div>
        </div>
      </div>
      <div className="learning-item">
        ...
        <div className="this-blurb">
          <div className="this-inner">
            <a href="">Jimmy Chin's five favorite winter destinations</a>
          </div>
        </div>
      </div>
      <div className="learning-item">
      ...
      <div className="learning-item">
        ...
        <div className="this-blurb">
          <div className="this-inner">
            <a href="">Preparing to buy a home: myths and truths</a>
          </div>
        </div>
      </div>
      <div className="learning-item">
        ...
        <div className="this-blurb">
          <div className="this-inner">
            <a href="">4 tips to remember when searching for a home</a>
          </div>
        </div>
      </div>
      <div className="learning-item">
        ...
        <div className="this-blurb">
          <div className="this-inner">
            <a href="">Ride-sharing is the new carpooling</a>
          </div>
        </div>
      </div>
    </div>
